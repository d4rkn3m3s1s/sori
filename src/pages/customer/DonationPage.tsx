...
import { 
  Droplet, Heart, TreePine, Award, Star, TrendingUp, 
              ...
              <Card className="bg-gradient-to-br from-blue-500 via-cyan-500 to-teal-500 relative overflow-hidden">
                ...
                <CardBody className="p-8 relative z-10">
                  <div className="flex flex-col md:flex-row items-center gap-6 text-white">
                    <div className="w-20 h-20 bg-white/20 backdrop-blur rounded-2xl flex items-center justify-center flex-shrink-0 animate-bounce">
                      <PartyPopper className="w-10 h-10 text-white" />
                    </div>
                    <div className="flex-1 text-center md:text-left">
                      <h3 className="text-2xl md:text-3xl font-bold mb-3 flex items-center justify-center md:justify-start gap-2">
                  ...
                  >
                    <Card className="h-full">
                      <CardBody className="p-6 text-center">
                        <div className={`w-16 h-16 mx-auto mb-3 bg-gradient-to-br ${cert.color} rounded-2xl flex items-center justify-center text-3xl shadow-lg`}>
                          {cert.icon}
                        </div>
                        ...
                        <Card className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700">
                          <CardBody className="p-4">
                            <div className="flex items-center gap-4">
                              {/* Emoji Icon */}
                              <div className="w-16 h-16 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-xl flex items-center justify-center text-3xl flex-shrink-0">
                                {donation.emoji}
                              </div>
      ...
      >
        <ModalContent>
          <ModalBody className="p-0">
            {selectedCertificate && (
              <div className="relative bg-gradient-to-br from-yellow-50 via-orange-50 to-yellow-50 dark:from-yellow-900/20 dark:to-orange-900/20 p-12 rounded-lg">
                {/* Decorative Border */}
