...
import { Card, CardBody, Input, Button, Link, Divider, Select, SelectItem } from '@nextui-org/react'
import { useNavigate } from 'react-router-dom'
import { Mail, Lock, Eye, EyeOff, QrCode, ArrowLeft, User, Building, Phone } from 'lucide-react'
...
function DealerRegister() {
  ...
  const businessTypes = [
    ...
    { key: 'hotel', label: 'Otel / Konaklama' },
    { key: 'retail', label: 'Perakende / Mağaza' },
    { key: 'service', label: 'Hizmet Sektörü' },
            ...
            <CardBody className="p-8">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Qratex'e katılın ve müşteri deneyiminizi geliştirin
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Select
                  label="İş Türü"
                  placeholder="İş türünüzü seçin"
                  variant="bordered"
                  classNames={{
                    trigger: "border-gray-200 hover:border-purple-300 focus:border-purple-500"
                  }}
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold py-3 text-base mt-6"
                  size="lg"
                >
                  Hesap Oluştur
                </Button>
