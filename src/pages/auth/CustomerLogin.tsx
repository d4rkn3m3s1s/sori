...
import { Mail, Lock, Eye, EyeOff, MessageSquare, ArrowLeft } from 'lucide-react'
            ...
            <CardBody className="p-8">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Geri bildirim paneline hoş geldiniz
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold py-3 text-base"
                  size="lg"
                >
                  Giriş Yap
                </Button>
